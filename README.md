...
This is sample code which consist of four interview questions. Each question have a module/function  which can be run/test by inserting the value in a form fields which that has been provided.
