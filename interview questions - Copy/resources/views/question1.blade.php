                        ...
                        <form id="question-1">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-4">
                                    ...
                                    <input class="form-control" id="var_a" name="var_a" type="text"  id="exampleFormControlInput1" placeholder="enter number only">
                                </div>
                                <div class="col-4">
                                    <label for="exampleFormControlInput1">Variable B</label>
                                    <input class="form-control" id="var_b" name="var_b" type="text"  id="exampleFormControlInput1" placeholder="enter number only">
                                </div>
                                <div class="col-4">
                                    <label for="exampleFormControlInput1">Variable C</label>
                                    <input class="form-control" id="var_c" name="var_c" type="text"  id="exampleFormControlInput1" placeholder="enter number only">
                                </div>
                            </div>
                           <br>
                            <br>
                            ...
                            <div class="row " style="display: inline-block">
                                <div id="ans" class="col-12 justify-content-md-center" >
